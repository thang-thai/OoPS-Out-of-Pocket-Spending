...
const Expense = ({ expense, handleEdit, handleDelete }) => {
  ...
  return (
    <tr id={expense_id}>
      <td className="cell">{expense_name}</td>
      ...
      <td className="btns">
        ...
        <button ref={inputRef} value={expense_id} onClick={e => handleRemove(e, inputRef.current.value)} className="btn-delete">
          {
